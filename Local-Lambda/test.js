...
function processEvent(event, context, callback) {
    ...
    if(jsonContents.grades != null) {
        for(var i = 0, len=jsonContents.grades.length; i < len; i++) {
            ...
            //the following line assigns the current date so we can more easily
    ...
    // allow re-use of database connections across calls to this
    // Lambda function and avoid closing the database connection.
